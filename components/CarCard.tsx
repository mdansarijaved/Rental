  ...
  return (
    <div className="car-card group">
      ...
      <div className="relative w-full h-40 my-3 object-contain">
        <Image src={getCarImageUrl(car)} alt="car" fill priority  />
      </div>
      <div className="relative flex w-full mt-2">
        ...
        <div className="car-card__btn-container text-gray bg-primary-blue rounded-full">
          <CustomButton title=" View More"
          containerStyles="w-full py-[16px] text-white " 
